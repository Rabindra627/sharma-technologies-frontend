        ...
        >
          {teamMembers.map((member, index) => (
            <motion.div
              ...
              whileHover={{ y: -8 }}
              className="group bg-white border border-slate-200/80 rounded-3xl p-7 flex flex-col justify-between items-center text-center shadow-xl shadow-slate-200/50 hover:shadow-2xl hover:border-blue-200 transition-all duration-300 relative"
            >
              <div className="flex flex-col items-center w-full">
                {/* Avatar with Animated Glow Outline */}
