...
export default function Hero() {
  return (
    <section
      id="about"
      className="relative min-h-screen flex items-center justify-center bg-gradient-to-r from-blue-600 to-indigo-700 text-white overflow-hidden"
    >
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 items-center gap-8 lg:gap-16 px-6 sm:px-8 lg:px-12 py-20">
        <div className="max-w-7xl mx-auto text-justify px-6">
          ...
          >
            is a software development company specializing in innovative web
